...
template sudoku() {
    ...
    component proofofrange[9][9][2];

    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {

            proofofrange[i][j][0] = proofofrange(4);
            proofofrange[i][j][1] = proofofrange(4);

            proofofrange[i][j][0].range[0] <== 0;
            proofofrange[i][j][0].range[1] <== 9;
            proofofrange[i][j][0].in <== puzzle[i][j];
            proofofrange[i][j][0].out === 1;

            proofofrange[i][j][1].range[0] <== 0;
            proofofrange[i][j][1].range[1] <== 9;
            proofofrange[i][j][1].in <== solution[i][j];
            proofofrange[i][j][1].out === 1;
